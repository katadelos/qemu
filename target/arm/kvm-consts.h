...
#define QEMU_PSCI_0_2_POWER_STATE_ID_MASK 0xffff
#define QEMU_PSCI_0_2_POWER_STATE_TYPE_SHIFT 16
#define QEMU_PSCI_0_2_POWER_STATE_TYPE_MASK \
    (1U << QEMU_PSCI_0_2_POWER_STATE_TYPE_SHIFT)
#define QEMU_PSCI_0_2_POWER_STATE_AFFL_SHIFT 24
#define QEMU_PSCI_0_2_POWER_STATE_AFFL_MASK \
    (3U << QEMU_PSCI_0_2_POWER_STATE_AFFL_SHIFT)
#define QEMU_PSCI_0_2_POWER_STATE_MASK \
    (QEMU_PSCI_0_2_POWER_STATE_ID_MASK | \
     QEMU_PSCI_0_2_POWER_STATE_TYPE_MASK | \
     QEMU_PSCI_0_2_POWER_STATE_AFFL_MASK)
...
MISMATCH_CHECK(QEMU_PSCI_0_2_POWER_STATE_ID_MASK,
               PSCI_0_2_POWER_STATE_ID_MASK);
MISMATCH_CHECK(QEMU_PSCI_0_2_POWER_STATE_TYPE_MASK,
               PSCI_0_2_POWER_STATE_TYPE_MASK);
MISMATCH_CHECK(QEMU_PSCI_0_2_POWER_STATE_AFFL_MASK,
